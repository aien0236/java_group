...
public class CommentDaoImpl {
    ...
    public boolean addComment(Comment comment) {
        ...
        try {
            ...
            pstmt = con.prepareStatement("INSERT INTO comments (comment_name, expiration_date, flag, flagged, price, discount, commenttype, quantity, retailer_id) " +
                    "VALUES(?, ?, ?, false, ?, ?, ?, ?, ?)");
    ...
    public boolean updateComment(Comment comment) {
        ...
        try {
            DataSource ds = new DataSource();
            con = ds.createConnection();
            pstmt = con.prepareStatement("UPDATE comments SET comment_name = ?, expiration_date = ?, flag = ?, flagged = ?, price = ?, discount = ?, commenttype = ?, quantity = ?, retailer_id = ? " +
                    "WHERE id = ?");
            pstmt.setString(4, comment.getComment());
            pstmt.setString(5, comment.getAuthor());
            pstmt.setInt(6, comment.getPost_id());
