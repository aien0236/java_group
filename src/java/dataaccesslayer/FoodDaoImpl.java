...
public class FoodDaoImpl {
        ...
        try {
            ...
            pstmt = con.prepareStatement(
                    "SELECT id, food_name, expiration_date, price, discount, foodtype, quantity, retailer_id " +
                            "FROM retailer_inventory WHERE flagged = false");
    ...
    public List<Food> getFlaggedFoods() {
        ...
        try {
            ...
            con = ds.createConnection();
            pstmt = con.prepareStatement(
                    "SELECT id, food_name, expiration_date, flagged, price, discount, foodtype, quantity, retailer_id" +
    ...
    public boolean addFood(Food food) {
        ...
        try {
            ...
            pstmt = con.prepareStatement("INSERT INTO retailer_inventory (food_name, expiration_date, flagged, price, discount, foodtype, quantity, retailer_id) " +
                    "VALUES(?, ?, ?, false, ?, ?, ?, ?, ?)");
    ...
    public Food getFoodById(int id) {
        ...
        try {
            ...
            con = ds.createConnection();
            // do not insert AuthorID, it is generated by Database
            pstmt = con.prepareStatement("SELECT id, food_name, expiration_date, flagged, price, discount, foodtype, quantity, retailer_id " +
    ...
    public boolean updateFood(Food food) {
        ...
        try {
            DataSource ds = new DataSource();
            con = ds.createConnection();
            pstmt = con.prepareStatement("UPDATE retailer_inventory SET food_name = ?, expiration_date = ?, flagged = ?, price = ?, discount = ?, foodtype = ?, quantity = ? " +
                    "WHERE id = ?");
            pstmt.setString(1, food.getFoodName());
            pstmt.setTimestamp(2, food.getExpiration_date());
            pstmt.setBoolean(3, food.isFlagged());
